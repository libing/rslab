...
<title><?php echo $cfg_webname; ?> - 投票</title>
...
.vote_area div a{display:inline-block;width:78px;height:25px;line-height:25px;background:url(templates/images/btn-style-gray.gif);text-align:center;font-family:"宋体";font-size:14px;overflow:hidden;cursor:pointer;}
