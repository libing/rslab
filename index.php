...
$(function(){
	...
	$(".newsfocus div img").LoadImage({width:60,height:58});
});
</script>
</head>
<body>
	...
	<div class="OneOfTwo">
		...
		<div class="newwarp">
			...
			<div class="newsfocus">
				...
				?>
				<div><img src="<?php echo $row['picurl']; ?>" width="60" height="58" /></div>
				<h3><a href="<?php echo $gourl; ?>" style="color:<?php echo $row['colorval']; ?>;font-weight:<?php echo $row['boldval']; ?>;"><?php echo ReStrLen($row['title'],15); ?></a></h3>
				<p><?php echo ReStrLen($row['description'],32); ?></p>
				<?php
				}
				else
				{
			...
			<ul class="newslist">
				...
				?>
				<li><span><?php echo MyDate('m-d', $row['posttime']); ?></span>· <a href="<?php echo $gourl; ?>" style="color:<?php echo $row['colorval']; ?>;font-weight:<?php echo $row['boldval']; ?>;"><?php echo ReStrLen($row['title'],18); ?></a></li>
				<?php
				}
				?>
			</ul>
	...
	<div class="scrollimg">
		<div class="imgwrap">
			<ul>
				...
				<li>
					<dl>
						<dt><a href="<?php echo $gourl; ?>"><img src="<?php echo $row['picurl']; ?>" title="<?php echo $row['title']; ?>" /></a></dt>
						<dd><a href="<?php echo $gourl; ?>"><?php echo $row['title']; ?></a><?php echo $row['size']; ?></dd>
					</dl>
				</li>
				<?php
				}
