		...
		<div class="overview"> 
			...
			<div class="menubox">
				...
				<div id="leftmenu02" style="display:none"> <a href="infoclass.php" target="main">栏目管理</a><a href="maintype.php" target="main">二级类别管理</a>
					...
					<div class="hr_1"> </div>
					<a href="diymenu.php" target="main">自定义菜单项</a> <a href="diyfield.php" target="main">自定义字段</a> <a href="infoflag.php" target="main" title="信息标记管理" class="infoattr"></a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
			...
			<div class="menubox">
				...
				<div id="leftmenu04" style="display:none"> <a href="goodstype.php" target="main">商品类别管理</a> <a href="goodsattr.php" target="main">商品属性管理</a><a href="goodsbrand.php" target="main">品牌类型管理</a> <a href="goodsflag.php" target="main" title="商品信息属性管理" class="goodsinfoattr"></a>
					<div class="hr_1"> </div>
