...
h1{margin-bottom:20px;padding-bottom:10px;border-bottom:1px solid #e5e5e5;line-height:32px;font-size:18px;color:#607280;font-family:"微软雅黑";}
h1 i{font-size:9px;}
...
.toptxt{position:absolute;right:20px;top:30px;font-size:12px;color:#0CF;}
.toptxt a{color:#666;}
...
::-webkit-scrollbar-thumb{background:#c2c2c2;background-clip:padding-box;border:1px solid #979797;min-height:28px;}
::-webkit-scrollbar-thumb:hover{border:1px solid #636363;background:#929292;}
::-webkit-scrollbar-track-piece{background-color:#eaeaea;border-left:1px solid #d2d2d2;}
</style>
</head>
<body>
<h1>开发帮助 <i>v1.5</i></h1>
<div class="toptxt"><strong><a href="home.php">到系统首页</a></strong></div>
<div class="uselist">
	<h2>单页信息调用</h2>
...
<div class="author">
	<h2>作者语</h2>
	<div class="hr_10"></div>
	<p>　　PHPMyWind 前台与后台完全采用PHP代码开发完成，测试过使用框架与模板引擎，虽然MVC很理想，可是却增加了二次开发的难度。PHPMyWind 主要面向的开发者就是企业建站行业的童鞋们。我们需要的是简单的，快速的，稳定的，拆分性较强的CMS。可能每个站只有几个栏目，亦或网站功能较为特殊需要定制。所以，对模块化要求极强。因此，我们总结上述几点是企业建站开发者们最需要的几点需求，以此为突破口，开发过程中时刻遵循于此。我们希望，开发者在开发的过程中感觉快速、舒适，这是我们的追求。</p>
	<div class="hr_10"></div>
...
<div class="footer">© 2012 phpMyWind.com</div>
</body>
</html>