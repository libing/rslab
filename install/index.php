	...
	case 3: //正在安装
		...
		if($_POST['s'] == 3)
		{
			...
			if($conn)
			{
				...
				//创建管理员
				mysql_query("INSERT INTO `".$dbinfo['tablepre']."admin` VALUES('1','".$admininfo['username']."','".md5(md5($admininfo['password']))."','127.0.0.1','".time()."','0','true');");
				...
				INSERT INTO `#@__webconfig` VALUES('1','cfg_author','网站作者','0','string','PHPMyWind Team','4');
				...
				INSERT INTO `#@__webconfig` VALUES('1','cfg_copyright','版权信息','0','bstring','Copyright © 2010 - 2012 phpMyWind.com All Rights Reserved','8');
				...
				INSERT INTO `#@__webconfig` VALUES('1','cfg_countcode','流量统计代码','1','bstring','','27');
				INSERT INTO `#@__webconfig` VALUES('1','cfg_qqcode','在线QQ　<br />(多个用\",\"分隔)','1','bstring','','28');
				...
				INSERT INTO `#@__webconfig` VALUES('1','cfg_reurl_vote','投票内容页','3','string','{vote}-{id}.html','75');
				INSERT INTO `#@__webconfig` VALUES('1','cfg_reurl_custom','自定义规则','3','string','{file}.html','76');

				INSERT INTO `#@__webconfig` VALUES('1','cfg_auth_key','标识码','4','string','$authkey','90');";
