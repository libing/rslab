...
$(function(){
    $(".product_list li img").LoadImage({width:210,height:140});
});
</script>
</head>
<body>
...
<div class="subBody">
	...
	<div class="TwoOfTwo">
		<div class="subTitle"> <span>您当前所在位置：<?php echo GetPosStr($cid); ?></span></span>
			<div class="cl"></div>
		</div>
		<div class="subCont">
			<ul class="product_list">
				...
				while($row = $dosql->GetArray())
				{
					...
					else $picurl = 'templates/images/nofoundpic.gif';
